...
Antes de este script, ese test set era solo una tabla markdown: no había
forma de "ejecutar el test set tras cada cambio de prompt o modelo" como
pide la Fase 4. Este script lo hace runnable y apto para CI (exit code 1 si
algún caso falla).
