...
Implements `ConversationStorage` (core/storage.py) — un backend real
(Redis/Postgres) puede reemplazar esta clase en server.py sin cambiar el
resto del sistema, siempre que exponga los mismos cuatro métodos.
"""
