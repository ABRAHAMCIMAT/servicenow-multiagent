...
def test_agent_cannot_act_as_admin():
    from backend.security.auth import Principal, ROLE_ADMIN, ROLE_AGENT
...
def test_user_cannot_act_as_agent():
    from backend.security.auth import Principal, ROLE_AGENT, ROLE_USER
...
def test_require_role_raises_403_when_insufficient():
    from backend.security.auth import Principal, ROLE_ADMIN, ROLE_USER, require_role
...
def test_require_role_passes_when_sufficient():
    from backend.security.auth import Principal, ROLE_AGENT, require_role
