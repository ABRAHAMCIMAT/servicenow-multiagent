...
C4Component
    ...
    Container_Boundary(api, "API Server") {
        Component(server, "server.py", "FastAPI", "Endpoints, auth/rate-limit, exception handlers")
...
C4Component
    ...
    Container_Boundary(api, "API Server") {
        ...
        Component(security, "Security", "llmops/security.py", "API key + rate limiting")
        Component(test_matrix, "TestMatrix", "llmops/test_matrix.py", "Generador de casos de prueba (HU-004)")

        Component(telemetry, "Telemetry", "observability/telemetry.py", "Eventos JSON estandarizados")
...
| `llmops/` | LLM facade, Guardrails, PromptRegistry, Evaluator, errores, Security, TestMatrix | 3b |
...
| `core/` | Modelos de dominio, LLMConfig, ConversationStorage/Store, paths | 3b |
